...
const DisqusJS = /*#__PURE__*/ forwardRef(({ shortname, siteName, identifier, url, title, api, apikey, nesting, nocomment, admin, adminLabel, className, disqusJsModeAssetsUrlTransformer, ...rest }, ref)=>{
