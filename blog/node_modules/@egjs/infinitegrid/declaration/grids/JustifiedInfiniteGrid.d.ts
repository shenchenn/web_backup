...
export declare class JustifiedInfiniteGrid extends InfiniteGrid<JustifiedInfiniteGridOptions> {
    static propertyTypes: {
        ...
        stretch: import("@egjs/grid").PROPERTY_TYPE;
        stretchRange: import("@egjs/grid").PROPERTY_TYPE;
        passUnstretchRow: import("@egjs/grid").PROPERTY_TYPE;
        inlineMargin: import("@egjs/grid").PROPERTY_TYPE;
        contentMargin: import("@egjs/grid").PROPERTY_TYPE;
        inlineOffset: import("@egjs/grid").PROPERTY_TYPE;
        contentOffset: import("@egjs/grid").PROPERTY_TYPE;
