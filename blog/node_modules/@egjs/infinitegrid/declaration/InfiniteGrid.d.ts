...
import { ContainerManager, Properties, RenderOptions, ItemRenderer, PROPERTY_TYPE } from "@egjs/grid";
...
declare class InfiniteGrid<Options extends InfiniteGridOptions = InfiniteGridOptions> extends Component<InfiniteGridEvents> {
    ...
    static infinitegridTypes: {
        isReachEnd: PROPERTY_TYPE;
        isReachStart: PROPERTY_TYPE;
    };
     ...
     * ```
     */
    insertByGroupIndex(groupIndex: number, items: InfiniteGridInsertedItems, groupKey?: string | number): this;
    /**
     ...
     */
    getStatus(type?: STATUS_TYPE, includePlaceholders?: boolean): InfiniteGridStatus;
    /**
    ...
    private _setIsReachStart;
    private _setIsReachEnd;
    private _syncItems;
    private _render;
    private _update;
