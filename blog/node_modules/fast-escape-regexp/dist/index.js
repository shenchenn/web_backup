 ...
 */ function escapeRegexp(str, unicodeMode = true) {
    ...
    for(const len = str.length; index < len; index++){
        /* eslint-disable sukka/unicorn/prefer-string-raw -- performance */ switch(str.charCodeAt(index)){
            case 94:
                escape = '\\^';
                break;
            case 46:
        ...
        /* eslint-enable sukka/unicorn/prefer-string-raw */ if (lastIndex !== index) {
